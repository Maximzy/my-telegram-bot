...
class PolicyHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path in ("/nezuko.png", "/nezuko_bg.png", "/uc_icon.png", "/prime_crown.png"):
            fname = {"nezuko_bg.png": "nezuko_bg.png", "nezuko.png": "nezuko.png", "uc_icon.png": "uc_icon.png", "prime_crown.png": "prime_crown.png"}.get(path.lstrip("/"), "nezuko.png")
